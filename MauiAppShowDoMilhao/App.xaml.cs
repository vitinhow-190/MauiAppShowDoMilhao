    ...
    public partial class App : Application
    {
        ...
        static List<Pergunta> perguntas_finais = new()
        {
            new Pergunta
            {
                        ...
                        Alternativas = new()
                        {
                            new Alternativa{ Correta=false, Descricao="Londres e Brasília" },
                            new Alternativa{ Correta=true, Descricao="Brasília e Roma" },
                            new Alternativa{ Correta=false, Descricao="Brasília e Barcelona" },
                            new Alternativa{ Correta=false, Descricao="Porto e Brasília" },
                        },
            },
             new Pergunta
             {
                        Id = 62,
                        Enunciado = " Quem foi a única pessoa na história a receber o Prêmio Nobel em áreas científicas diferentes?",
                        Alternativas = new()
                        {
                            new Alternativa{ Correta=false, Descricao="Albert Einstein" },
                            new Alternativa{ Correta=true, Descricao="Linus Pauling" },
             ...
             {
                        Id = 63,
                        Enunciado = " Quem foi a primeira mulher a se eleger presidente de um país?",
                        Alternativas = new()
                        {
                            new Alternativa{ Correta=false, Descricao="Dilma Roussef" },
                            new Alternativa{ Correta=true, Descricao="Cristina Kirchner" },
                            new Alternativa{ Correta=false, Descricao="Marie Curie" },
                            new Alternativa{ Correta=false, Descricao="Stephen Hawking" },
                        },
             },
